...
<head>
    ...
    <style>
        body { font-family: 'Times New Roman', Times, serif; font-size: 13px; margin: 0; padding: 0; color: #000; }
        ...
        .company-name { font-size: 24px; font-weight: bold; color: #1e4d8c; margin-bottom: 2px; }
        ...
        .item-data td { border-bottom: none !important; border-top: none !important; padding-top: 10px; }
        .empty-height td { border-bottom: none !important; border-top: none !important; height: 130px; }
    </style>
</head>
<body>
    ...
    <tbody>
            ...
            <td colspan="7" style="padding: 0; border-bottom: 1px solid #000;">
                <table style="width: 100%; border-collapse: collapse; border: none;">
                    <tr>
                        ...
                        <td style="width: 25%; border: none; border-bottom: 1px solid #000; padding: 5px;vertical-align: top;">
        ...
        <tr>
            <td colspan="7" style="padding: 0; border-bottom: 1px solid #000;">
                <table style="width: 100%; border-collapse: collapse; border: none;">
                    <tr>
                        <td style="width: 50%; border: none; border-right: 1px solid #000; padding: 5px; vertical-align: top;">
                            <div style="margin-bottom: 5px; font-size: 14px;"><strong>Buyer :- {{ strtoupper($invoice->client->name) }}.</strong></div>
                            ...
                            <table style="width: 100%; border: none; font-size: 13px;">
                                <tr>
                                    <td style="border: none; padding: 0;">State: {{ strtoupper($invoice->client->state) }}</td>
                                    <td style="border: none; padding: 0; text-align: right;">State Code: {{ $invoice->client->state_code }}</td>
                                </tr>
                            </table>
                        </td>
                        <td style="width: 50%; border: none; padding: 0; vertical-align: top;">
                            ...
                            <table style="width: 100%; border: none; font-size: 13px; margin-top: 5px; padding: 0 5px;">
                                <tr>
        ...
        <tr>
            ...
            <td class="no-border-top no-border-bottom"></td>
            <td class="no-border-top no-border-bottom"></td>
            <td style="border-top: 1px solid #000; border-bottom: none; padding-bottom:5px;">CGST@<br>{{ $invoice->items->first()?->product?->tax_rate / 2 ?? 0 }}%</td>
            <td style="border-top: 1px solid #000; border-bottom: none; text-align:center;">{{ number_format($cgst, 2) }}</td>
        </tr>
        <tr>
            <td class="no-border-top no-border-bottom"></td>
            <td class="no-border-top no-border-bottom"></td>
            ...
            <td class="no-border-top no-border-bottom"></td>
            <td class="no-border-top no-border-bottom"></td>
            <td style="border-bottom: none; border-top: none;">SGST@<br>{{ $invoice->items->first()?->product?->tax_rate / 2 ?? 0 }}%</td>
        ...
        <tr>
            ...
            <td class="no-border-top no-border-bottom"></td>
            <td class="no-border-top no-border-bottom"></td>
            <td style="border-top: 1px solid #000; border-bottom: none;border-top: none; padding-bottom:5px;">IGST@<br>{{ $invoice->items->first()?->product?->tax_rate ?? 0 }}%</td>
            <td style="border-top: 1px solid #000; border-bottom: none; text-align:center;">{{ number_format($igst, 2) }}</td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td style="border-bottom: none; border-top: none; text-align:center; padding-top:15px; padding-bottom:15px;">0.00</td>
        </tr>
        ...
        <tr>
            ...
            <th></th>
            <th></th>
            <th class="text-center" style="font-weight: bold;">{{ number_format(round($invoice->grand_total), 2) }}</th>
        </tr>
                        ...
                        <tr>
                            ...
                            <td style="border: none;padding: 0;width: 40%;vertical-align: bottom;text-align: right;border: 1px solid #000;border-bottom: 0;border-right: 0;">
                                <div style="">
                                    ...
                                    <div style="margin-top: 40px; width: 100%; text-align: center;">Authorised signatory</div>
                                </div>
                            </td>
                        </tr>
                    </table>
